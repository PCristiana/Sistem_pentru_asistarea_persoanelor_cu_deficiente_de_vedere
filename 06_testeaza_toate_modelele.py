...
SPLIT = "test"
OUTPUT_FOLDER_NAME = "metrici_testare"
SUMMARY_CSV_NAME = "rezumat_metrici_testare.csv"
...
def main():
    ...
    print(f"Rulez testarea pe split='{SPLIT}'")
    ...
    for experiment_name in EXPERIMENTS:
        ...
        metrics = model.val(
            ...
            name="testare_best_model",
        )

        global_csv = output_dir / "metrici_globale_testare.csv"
        per_class_csv = output_dir / "metrici_pe_clase_testare.csv"
